...
long x_postscript_window (Display *, Window, ListHeader *, char*);
     ...
     long value;
{
  ...
  if(n) {
    ...
    deref_ptr(t1);
    if(!t1->value) {
      push_ptr_value(int_ptr,(GENERIC *)&(t1->value));
    ...
    *(REAL *)t1->value =(REAL) value;
    ...
    t1->value=heap_alloc(sizeof(REAL));
    *(REAL *)t1->value =(REAL) value;
    bk_stack_insert(FEATCMP,(GENERIC)perm,&(t->attr_list),(GENERIC)t1);
  }
}
     ...
     ptr_psi_term value;
{
  ...
  if(n) {
    ...
    *t1= *value;
    ...
    bk_stack_insert(FEATCMP,(GENERIC)perm,&(t->attr_list),(GENERIC)value);
}
...
{
  deref_ptr(lst);
  stack_insert(FEATCMP,(GENERIC)one,&(lst->attr_list),(GENERIC)value);
}
...
{
  deref_ptr(lst);
  stack_insert(FEATCMP,(GENERIC)two,&(lst->attr_list),(GENERIC)value);
}
