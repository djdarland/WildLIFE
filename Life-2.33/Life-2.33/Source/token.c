...
/*! \fn void TOKEN_ERROR(ptr_psi_term p)  
  \brief TOKEN_ERROR
...
/*! \fn void stdin_cleareof()
  \brief stdin_cleareof
...
/*! \fn void heap_add_int_attr(ptr_psi_term t, char *attrname, long value)
  \brief heap_add_int_attr
...
/*! \fn void stack_add_int_attr(ptr_psi_term t, char *attrname, long value)
  \brief stack_add_int_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param value - long value
...
/*! \fn void heap_mod_int_attr(ptr_psi_term t, char *attrname, long value)
  \brief heap_mod_int_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param value - long value
...
/*! \fn void heap_add_str_attr(ptr_psi_term t, char *attrname, char *str)
  \brief heap_add_str_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param str - char *str
...
/*! \fn void stack_add_str_attr(ptr_psi_term t, char *attrname, char *str)
  \brief stack_add_str_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param str - char *str
...
/*! \fn void heap_mod_str_attr(ptr_psi_term t, char *attrname, char *str)
  \brief heap_mod_str_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param str - char *str
...
/*! \fn void heap_add_psi_attr(ptr_psi_term t, char *attrname, ptr_psi_term g)
  \brief heap_add_psi_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
...
/*! \fn void stack_add_psi_attr(ptr_psi_term t, char *attrname, ptr_psi_term g)
  \brief stack_add_psi_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param g - ptr_psi_term g
...
/*! \fn void bk_stack_add_psi_attr(ptr_psi_term t, char *attrname, ptr_psi_term g)
  \brief bk_stack_add_psi_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
  \param g - ptr_psi_term g
...
/*! \fn GENERIC get_attr(ptr_psi_term t, char *attrname)
  \brief get_attr
  \param t - ptr_psi_term t
  \param attrname - char *attrname
...
/*! \fn FILE *get_stream(ptr_psi_term t)
  \brief get_stream
  \param t - ptr_psi_term t
...
/*! \fn void save_state(ptr_psi_term t)
  \brief save_state
  \param t - ptr_psi_term t
...
/*! \fn void restore_state(ptr_psi_term t)
  \brief restore_state
  \param t - ptr_psi_term t
...
/*! \fn void new_state(ptr_psi_term *t)
  \brief new_state
  \param t - ptr_psi_term *t
...
/*! \fn void save_parse_state(ptr_parse_block pb)
  \brief save_parse_state
  \param pb - ptr_parse_block pb
...
/*! \fn void restore_parse_state(ptr_parse_block pb)
  \brief restore_parse_state
  \param pb - ptr_parse_block pb
...
/*! \fn void init_parse_state()
  \brief init_parse_state
...
/*! \fn void begin_terminal_io()
  \brief begin_terminal_io
...
/*! \fn void end_terminal_io()
  \brief end_terminal_io
...
/*! \fn char *expand_file_name(char *s)
  \brief expand_file_name
  \param s - char *s
...
/*! \fn long open_input_file(char *file)
  \brief open_input_file
  \param file - char *file
...
/*! \fn long open_output_file(string file)
...
/*! \fn void put_back_token(psi_term t)
  \brief put_back_token
  \param t - psi_term t
...
/*! \fn void psi_term_error()
  \brief psi_term_error
...
/*! \fn void read_comment(ptr_psi_term tok)
  \brief read_comment
...
/*! \fn void read_string_error(int n)
  \brief read_string_error
  \param n - int n
...
/*! \fn void read_string(ptr_psi_term tok,long e)
  \brief read_string
  \param tok - ptr_psi_term tok
  \param e - long e
...
/*! \fn void read_name(ptr_psi_term tok,long ch,long (*f)(long),ptr_definition typ)
  \brief read_name
  \param tok - ptr_psi_term tok
  \param ch - long ch
  \param f - long (*f)(long)
...
void read_name(ptr_psi_term tok,long ch,long (*f)(long),ptr_definition typ)
{
  ...
  if(typ==constant) {
    ...
    if (FALSE /*tok->type->type==global_it && tok->type->global_value*/) {
      /*  RM: Nov 10 1993  */
...
/*! \fn void read_number(ptr_psi_term tok,long c)
  \brief read_number
  \param tok - ptr_psi_term tok
  \param c - long c
...
/*! \fn void read_token(ptr_psi_term tok)
  \brief read_token
  \param tok - ptr_psi_term tok
...
/*! \fn void read_token_b(ptr_psi_term tok)
  \brief read_token_b
  \param tok - ptr_psi_term tok
...
/*! \fn void read_token_main(ptr_psi_term tok, long for_parser)
  \brief read_token_main
  \param tok - ptr_psi_term tok
  \param for_parser - long for_parser
