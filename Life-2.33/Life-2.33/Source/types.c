...
/*! \fn void print_def_type(def_type t)
  \brief print_def_type
  \param t - def_type t
...
/*! \fn void remove_cycles(ptr_definition d, ptr_int_list *dl)
  \brief remove_cycles
  \param d - ptr_definition d
  \param dl - ptr_int_list *dl
...
/*! \fn long redefine(ptr_psi_term t)
  \brief redefine
...
/*! \fn ptr_int_list cons(GENERIC v,ptr_int_list l)
  \brief cons
  \param v - GENERIC v
...
/*! \fn long assert_less(ptr_psi_term t1,ptr_psi_term t2)
  \brief assert_less
  \param t1 - ptr_psi_term t1
  \param t2 - ptr_psi_term t2
...
/*! \fn void assert_protected(ptr_node n,long prot)
  \brief assert_protected
  \param n - ptr_node n
  \param prot - long prot
...
/*! \fn void assert_args_not_eval(ptr_node n)
  \brief assert_args_not_eval
  \param n - ptr_node n
...
/*! \fn void assert_delay_check(ptr_node n)
  \brief assert_delay_check
  \param n - ptr_node n
...
/*! \fn void clear_already_loaded(ptr_node n)
  \brief clear_already_loaded
  \param n - ptr_node n
...
/*! \fn void assert_type(ptr_psi_term t)
  \brief assert_type
  \param t - ptr_psi_term t
...
/*! \fn void assert_complicated_type(ptr_psi_term t)
  \brief assert_complicated_type
  \param t - ptr_psi_term t
...
/*! \fn void assert_attributes(ptr_psi_term t)
  \brief assert_attributes
  \param t - ptr_psi_term t
...
/*! \fn void insert_own_prop(ptr_definition d)
  \brief insert_own_prop
  \param d - ptr_definition d
...
/*! \fn void insert_prop(ptr_definition d,ptr_triple_list prop)
  \brief insert_prop
  \param d - ptr_definition d
  \param prop - ptr_triple_list prop
...
/*! \fn void propagate_definitions()
  \brief propagate_definitions
...
/*! \fn ptr_int_list two_to_the(long p)
  \brief two_to_the
  \param p - long p
...
/*! \fn ptr_int_list copyTypeCode(ptr_int_list u)
  \brief copyTypeCode
  \param u - ptr_int_list u
...
/*! \fn void or_codes(ptr_int_list u,ptr_int_list v)
  \brief or_codes
  \param u - ptr_int_list u
  \param v - ptr_int_list v
...
/*! \fn void equalize_codes(int len) 
  \brief equalize_codes
  \param len - int len
...
/*! \fn void make_type_link(ptr_definition t1,ptr_definition t2)
  \brief make_type_link
  \param t1 - ptr_definition t1
  \param t2 - ptr_definition t2
...
/*! \fn long type_member(ptr_definition t,ptr_int_list tlst)
  \brief type_member
  \param t - ptr_definition t
  \param tlst - ptr_int_list tlst
...
/*! \fn void perr_sort(ptr_definition d)
  \brief perr_sort
  \param d - ptr_definition d
...
/*! \fn void perr_sort_list(ptr_int_list anc)
  \brief perr_sort_list
  \param anc - ptr_int_list anc
...
/*! \fn void perr_sort_cycle(ptr_int_list anc)
  \brief perr_sort_cycle
  \param anc - ptr_int_list anc
...
/*! \fn long type_cyclicity(ptr_definition d,ptr_int_list anc)
  \brief type_cyclicity
  \param d - ptr_definition d
  \param anc - ptr_int_list anc
...
/*! \fn void propagate_always_check(ptr_definition d,long *ch)
  \brief propagate_always_check
  \param d - ptr_definition d
  \param ch - long *ch
...
/*! \fn void one_pass_always_check(long *ch)
  \brief one_pass_always_check
  \param ch - long *ch
...
/*! \fn void inherit_always_check()
  \brief inherit_always_check
...
/*! \fn long glb_value(long result,long f,GENERIC c,GENERIC value1,GENERIC value2,GENERIC *value)
  \brief glb_value
  \param result - long result
  \param f - long f
  \param c - GENERIC c
  \param value1 - GENERIC value1
  \param value2 - GENERIC value2
...
/*! \fn long glb_code(long f1,GENERIC c1,long f2,GENERIC c2,long *f3,GENERIC *c3)
  \brief glb_code
  \param f1 - long f1
  \param c1 - GENERIC c1
  \param f2 - long f2
...
/*! \fn long glb(ptr_definition t1,ptr_definition t2,ptr_definition *t3,ptr_int_list *c3)
  \brief glb
  \param t1 - ptr_definition t1
  \param t2 - ptr_definition t2
  \param t3 - ptr_definition *t3
  \param c3 - ptr_int_list *c3
...
/*! \fn long overlap_type(ptr_definition t1,ptr_definition t2)
  \brief overlap_type
  \param t1 - ptr_definition t1
  \param t2 - ptr_definition t2
...
/*! \fn long sub_CodeType(ptr_int_list c1,ptr_int_list c2)
  \brief sub_CodeType
  \param c1 - ptr_int_list c1
  \param c2 - ptr_int_list c2
...
/*! \fn long sub_type(ptr_definition t1,ptr_definition t2)
  \brief sub_type
  \param t1 - ptr_definition t1
  \param t2 - ptr_definition t2
...
/*! \fn long matches(ptr_definition t1,ptr_definition t2,long *smaller)
  \brief matches
  \param t1 - ptr_definition t1
  \param t2 - ptr_definition t2
  \param smaller - long *smaller
...
/*! \fn long strict_matches(ptr_psi_term t1,ptr_psi_term t2,long *smaller)
  \brief strict_matches
  \param t1 - ptr_psi_term t1
  \param t2 - ptr_psi_term t2
  \param smaller - long *smaller
...
/*! \fn long bit_length(ptr_int_list c)
  \brief bit_length
...
/*! \fn ptr_int_list decode(ptr_int_list c)
  \brief decode
  \param c - ptr_int_list c
