...
/*! \fn void get_two_args(ptr_node t,ptr_psi_term *a,ptr_psi_term *b)
  \brief get_two_args
  \param t - ptr_node t,
...
/*! \fn void get_one_arg(ptr_node t,ptr_psi_term *a)
  \brief get_one_arg
  \param t - ptr_node t
  \param a - ptr_psi_term *a
...
/*! \fn void get_one_arg_addr(ptr_node t,ptr_psi_term **a)
  \brief get_one_arg_addr
  \param t - ptr_node t
  \param a - ptr_psi_term **a
...
/*! \fn void add_rule(ptr_psi_term head,ptr_psi_term body,def_type typ)
  \brief add_rule
  \param head - ptr_psi_term head
  \param body - ptr_psi_term body
  \param typ - def_type typ
...
/*! \fn void assert_rule(psi_term t,def_type typ)
  \brief assert_rule
  \param t - psi_term t
  \param typ - def_type typ
...
/*! \fn void assert_clause(ptr_psi_term t)
  \brief assert_clause
...
/*! \fn push_ptr_value(type_ptr t,GENERIC *p)
  \brief push_ptr_value
  \param t - type_ptr t
  \param p - GENERIC *p
...
/*! \fn void push_def_ptr_value(ptr_psi_term q,GENERIC *p)
  \brief push_def_ptr_value
  \param q - ptr_psi_term q
  \param p - GENERIC *p
...
/*! \fn void push_psi_ptr_value(ptr_psi_term q,GENERIC *p)
  \brief push_psi_ptr_value
  \param q - ptr_psi_term q
  \param p - GENERIC *p
...
/*! \fn void push_ptr_value_global(type_ptr t,GENERIC *p)
  \brief push_ptr_value_global
  \param t - type_ptr t
  \param p - GENERIC *p
...
/*! \fn void push_window(long type,long disp,long wind)
  \brief push_window
  \param type - long type
  \param disp - long disp
  \param wind - long wind
...
/*! \fn void push2_ptr_value(type_ptr t,GENERIC *p,GENERIC v)
  \brief push2_ptr_value
  \param t - type_ptr t
  \param p - GENERIC *p
  \param v - GENERIC v
  
  PUSH2_PTR_VALUE(t,*p,v)
...
/*! \fn void push_goal(goals t,ptr_psi_term aaaa_5,ptr_psi_term bbbb_5,GENERIC cccc_5)
  \brief push_goal
  \param t - goals t
  \param aaaa_5 ptr_psi_term aaaa_5
  \param bbbb_5 ptr_psi_term bbbb_5
  \param cccc_5 GENERIC cccc_5
...
/*! \fn void push_choice_point(goals t,ptr_psi_term aaaa_6,ptr_psi_term bbbb_6,GENERIC cccc_6)
  \brief push_choice_point
  \param t - goals t
  \param aaaa_6 ptr_psi_term aaaa_6
  \param bbbb_6 ptr_psi_term bbbb_6
  \param cccc_6 GENERIC cccc_6
...
/*! \fn void undo(ptr_stack limit)
  \brief undo
  \param limit - ptr_stack limit
...
/*! \fn static void clean_trail(ptr_choice_point cutpt)
  \brief clean_trail
  \param cutpt - ptr_choice_point cutpt
...
/*! \fn void clean_undo_window(long disp,long wind)
  \brief clean_undo_window
  \param disp - long disp
  \param wind - long wind
...
/*! \fn void merge1(ptr_node *u,ptr_node v)
  \brief merge1
  \param u - ptr_node *u
  \param v - ptr_node v
...
/*! \fn merge2(ptr_node *u,ptr_node v)
  \brief merge2
  \param u - ptr_node *u
  \param v - ptr_node v
...
/*! \fn void merge3(ptr_node *u,ptr_node v)
  \brief merge3
  \param u - ptr_node *u
  \param v - ptr_node v
...
/*! \fn void merge(ptr_node *u,ptr_node v)
  \brief merge
  \param u - ptr_node *u
  \param v - ptr_node v
...
void merge(ptr_node *u,ptr_node v)
{
  ...
  if (v) {
    if (*u==NULL) {
      ...
      push_ptr_value(int_ptr,(ptr_psi_term *)u);
      (*u)=STACK_ALLOC(node);
      **u= *v;
      more_v_attr=TRUE;
...
/*! \fn void merge_unify(ptr_node *u,ptr_node v)
  \brief merge_unify
  \param u - ptr_node *u
  \param v - ptr_node v
...
/*! \fn void fetch_def(ptr_psi_term u,long allflag)
  \brief fetch_def
  \param u - ptr_psi_term u
  \param allflag - long allflag
...
/*! \fn void fetch_def_lazy(ptr_psi_term u, ptr_definition old1, ptr_definition old2, ptr_node old1attr, ptr_node old2attr, long old1stat, long old2stat)
  \brief fetch_def_lazy
  \param u -ptr_psi_term u
  \param old1 - ptr_definition old1
  \param old2 - ptr_definition old2
  \param old1attr - ptr_node old1attr
  \param old2attr - ptr_node old2attr
  \param old1stat - long old1stat
  \param old2stat - long old2stat
...
/*! \fn long unify_aim_noeval()
  \brief unify_aim_noeval
...
/*! \fn long unify_body(long eval_flag)
  \brief unify_body
  \param eval_flag - long eval_flag
...
/*! \fn long num_vars(ptr_node vt)
  \brief num_vars
  \param vt - ptr_node vt
...
/*! \fn ptr_choice_point topmost_what_next()
  \brief topmost_what_next
...
/*! \fn int dummy_printf(char *f,char *s,char *t)
  \brief dummy_printf
  \param f - char *f
  \param s - char *s
  \param t - char *t
...
/*! \fn long trail_condition(psi_term *Q)
  \brief trail_condition
  \param Q - psi_term *Q
